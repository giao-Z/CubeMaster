...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    arMode: "AR Mode",
    scanning: "Scanning",
    alignFace: "Align the {size}x{size} face within the grid",
    tapToFix: "Tap color circle, then tap grid to fix",
    algorithm: "Algorithm",
    comingSoon: "Content coming soon...",
    errorTitle: "Error",
    invalidState: "Invalid Cube State",
    colorCountError: "Color counts are incorrect. Please verify your scan.",
    // Directions & Colors
    dirTop: 'Top',
    dirBottom: 'Bottom',
    dirLeft: 'Left',
  ...
  zh: {
    ...
    arMode: "AR 模式",
    scanning: "扫描中",
    alignFace: "将 {size}x{size} 魔方对准网格",
    tapToFix: "点击颜色，再点击网格以修正",
    algorithm: "公式",
    comingSoon: "内容即将推出...",
    errorTitle: "错误",
    invalidState: "魔方状态无效",
    colorCountError: "颜色数量不正确，请检查扫描结果。",
    dirTop: '上方',
    dirBottom: '下方',
    dirLeft: '左侧',
    dirRight: '右侧',
  ...
  es: {
    ...
    arMode: "Modo AR",
    scanning: "Escaneando",
    alignFace: "Alinea la cara de {size}x{size}",
    tapToFix: "Toca color, luego toca cuadrícula",
    algorithm: "Algoritmo",
    comingSoon: "Próximamente...",
    errorTitle: "Error",
    invalidState: "Estado Inválido",
    colorCountError: "El conteo de colores es incorrecto.",
    dirTop: 'Arriba',
    dirBottom: 'Abajo',
    dirLeft: 'Izquierda',
    dirRight: 'Derecha',
    ...
    colorOrange: 'Naranja',
    faceU: "Arriba (Blanco)",
    faceD: "Abajo (Amarillo)",
    faceF: "Frente (Verde)",
    faceB: "Atrás (Azul)",
    faceL: "Izquierda (Naranja)",
    faceR: "Derecha (Rojo)",
  },
  fr: {
    appTitle: 'CubeMaster Pro',
    ...
    arMode: "Mode AR",
    scanning: "Scan",
    alignFace: "Alignez la face {size}x{size}",
    tapToFix: "Touchez la couleur puis la grille",
    algorithm: "Algorithme",
    comingSoon: "Bientôt disponible...",
    errorTitle: "Erreur",
    invalidState: "État Invalide",
    colorCountError: "Erreur de comptage des couleurs.",
    dirTop: 'Haut',
    dirBottom: 'Bas',
    dirLeft: 'Gauche',
    dirRight: 'Droite',
  ...
  ru: {
    ...
    alignFace: "Выровняйте грань {size}x{size}",
    tapToFix: "Выберите цвет, затем клетку",
    algorithm: "Алгоритм",
    comingSoon: "Скоро...",
    errorTitle: "Ошибка",
    invalidState: "Неверное состояние",
    colorCountError: "Неверное количество цветов.",
    dirTop: 'Верх',
    dirBottom: 'Низ',
    dirLeft: 'Лево',
    dirRight: 'Право',
  ...
  ar: {
    ...
    scanning: "جاري المسح",
    alignFace: "قم بمحاذاة وجه {size}x{size}",
    tapToFix: "اضغط اللون ثم المربع للتصحيح",
    algorithm: "خوارزمية",
    comingSoon: "قريبا...",
    errorTitle: "خطأ",
    invalidState: "حالة مكعب غير صالحة",
    colorCountError: "أعداد الألوان غير صحيحة.",
    dirTop: 'أعلى',
    dirBottom: 'أسفل',
    dirLeft: 'يسار',
    dirRight: 'يمين',
